...
public class Runner {
	...
	public static void main(String[] args) throws BiffException, IOException {
		...
		File f = new File("E:\\Selenium Classes\\Day 25\\Testcases.xls"); // excel file
		...
		for (int i = 1; i < rows; i++) {
			...
			if (c.getContents().equals("Y")||c.getContents().equals("y")||c.getContents().equals("Yes")||c.getContents().equals("yes")) {
